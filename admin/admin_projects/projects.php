    ...
    <section class="section" id="testimonials-admin">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 mobile-bottom-fix-big" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                    <div class="owl-carousel owl-theme">
                        ...
                        $sluzba_map = [
                            'seo' => 'SEO',
                            'soc_siete' => 'Sociálne siete',
                            'ppc' => 'PPC reklama'
                        ];

                        foreach($projects as $key => $item){
                            $sluzba_custom = isset($sluzba_map[$item['sluzba']]) ? $sluzba_map[$item['sluzba']] : '';
                            echo '<div class="item author-item">
                   <h4>'.$item['partner'].'</h4>
                   <span>'.$sluzba_custom.'</span>
                   <div class="member-thumb d-flex justify-content-center">
                   </div>
                   
                   <div class="d-flex justify-content-center">
                     <a href="update_form_projects.php?id='.$item['id'].'" class="main-filled-button m-1"><i class="fas fa-edit"></i></a>
                     <a href="delete_projects.php?id='.$item['id'].'" class="main-filled-button m-1"><i class="fas fa-trash-alt"></i></a>
                   </div>
                  </div>'
                            ;
                        }
            ...
            <div style="width: 100%; text-align: center; margin-top: 2em;">
                <a href="home_projects.php" class="main-filled-button">Vložiť projekt</a>
            </div>
        </div>
    </section>
