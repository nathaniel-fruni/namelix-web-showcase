        ...
        <section class="section">
            <div class="container">
                <div style="width: 100%; text-align: center;">
                    <h2 style="color:white; margin-bottom: 1.5em;">Vložiť banner</h2>
                </div>
                            ...
                            <form action="home_banner.php" method="post">
                                <div class="row text-center">
                                    <div class="col-md-6 col-sm-12">
                                        <fieldset>
                                            <input name="popis1" type="text" placeholder="Popis 1" required>
                                        </fieldset>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <fieldset>
                                            <input name="popis2" type="text" placeholder="Popis 2" required>
                                        </fieldset>
                                    </div>
