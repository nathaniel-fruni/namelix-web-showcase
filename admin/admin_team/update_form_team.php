    ...
    <section class="section">
        <div class="container">
            <div style="width: 100%; text-align: center;">
                <h2 style="color:white; margin-bottom: 1.5em;">Upraviť údaje člena tímu</h2>
            </div>
                        ...
                        <form action="update_team.php" method="post">
                            <div class="row text-center">
                                <div class="col-md-6 col-sm-12">
                                    <fieldset>
                                        <input name="meno" type="text" placeholder="Meno" value="<?php echo $teamItem['meno']; ?>" required>
                                    </fieldset>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <fieldset>
                                        <input name="priezvisko" type="text" placeholder="Priezvisko" value="<?php echo $teamItem['priezvisko']; ?>" required>
                                    </fieldset>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <fieldset>
                                        <input name="pozicia" type="text" placeholder="Pozícia" value="<?php echo $teamItem['pozicia']; ?>" required>
                                    </fieldset>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <fieldset>
                                        <input name="picture_name" type="text" placeholder="Názov fotky" value="<?php echo $teamItem['picture_name']; ?>" required>
                                    </fieldset>
                                </div>
