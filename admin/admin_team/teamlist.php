...
<section class="section" id="testimonials-admin">
    <div class="container">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 mobile-bottom-fix-big" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                <div class="owl-carousel owl-theme">
                   ...
                   <div class="d-flex justify-content-center">
                     ...
                     <a href="update_form_team.php?id='.$item['id'].'" class="main-filled-button m-1"><i class="fas fa-edit"></i></a>
                     <a href="delete_team.php?id='.$item['id'].'" class="main-filled-button m-1"><i class="fas fa-trash-alt"></i></a>
                   </div>
                  </div>'
                        ;
                    }
        ...
        <div style="width: 100%; text-align: center; margin-top: 2em;">
            <a href="home_team.php" class="main-filled-button">Vložiť člena tímu</a>
        </div>
    </div>
</section>
